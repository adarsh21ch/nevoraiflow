/**
 * Data masking helpers for sensitive PII.
 * Masks shown to admins/UI by default; full value only on explicit reveal.
 */

const safe = (v: unknown): string => (v == null ? "" : String(v));

/** Show last 4 chars: "XXXXXXX1234" */
...
/** Aadhaar: 12-digit, show last 4: XXXX XXXX 1234 */
...
/** IFSC: not strictly secret but mask middle: ABCD0XXXXXX */
