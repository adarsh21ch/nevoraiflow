...
/**
 * Mirrors the edge function's computeSlots. Returns timestamps (ms) within a window:
 * 2 days before now → 60 days after, capped by repeat_end_date.
 */
...
/** Effective UI status taking repeats into account */
