...
/**
 * Polished post-registration video player used on landing-page success state.
 * Autoplay-muted with "tap to unmute" hint, custom seek bar, fullscreen toggle,
