...
/**
 * Full-screen access-code gate for a private landing page.
 * Mirrors CodeGateScreen styling so funnel + landing-page gates feel consistent.
 */
    ...
    >
      <div className="w-full max-w-sm text-center">
        ...
        <div
          ...
          style={{ background: "#141419", border: "1px solid #27272a" }}
        >
          <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-5">
            <Shield size={28} className="text-primary" />
          </div>
          <h2 className="text-xl font-heading font-bold mb-1 text-white">
            {pageTitle}
          </h2>
          ...
          <p
            className="text-[10px] mt-4 flex items-center justify-center gap-1"
            style={{ color: "#94a3b8" }}
          >
