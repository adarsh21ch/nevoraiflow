...
/**
 * Three-segment DD / MM / YYYY input with auto-advance, paste handling,
 * and validation. Emits "" while incomplete, full ISO date once valid.
 */
export const DateOfBirthInput = ({
  ...
  const baseCls = `bg-input text-foreground placeholder:text-muted-foreground text-center ${heightCls} ${
    hasError ? "border-destructive" : "border-border"
  } border rounded-md focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/60 transition`;
