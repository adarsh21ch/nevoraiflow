              ...
              <div>
                ...
                <div className="mt-2 space-y-2">
                  <label className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all ${
                    form.sender_display_name === "nFlow" ? "border-primary bg-primary/5" : "border-border bg-muted/50 hover:border-muted-foreground/30"
                  }`}>
                    <input
                      type="radio"
                      name="sender_display_name"
                      checked={form.sender_display_name === "nFlow"}
                      onChange={() => updateField("sender_display_name", "nFlow")}
                  ...
                  <label className={`flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-all ${
                    ...
                    <input
                      ...
                      name="sender_display_name"
                      checked={form.sender_display_name !== "nFlow"}
                      onChange={() => updateField("sender_display_name", form.sender_display_name !== "nFlow" ? form.sender_display_name : (profile?.full_name || ""))}
                      className="accent-primary"
                    />
                ...
                <p className="text-[11px] text-muted-foreground/70 mt-2">
                  Email will appear as: <span className="font-mono text-foreground/60">{form.sender_display_name || "nFlow"} &lt;noreply@flow.nevorai.com&gt;</span>
                </p>
              </div>
            </div>
