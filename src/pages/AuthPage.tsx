      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="auth-card p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="button" variant="outline" className="w-full" size="lg" disabled={submitting || !!oauthLoading}
              onClick={async () => {
              ...
              {oauthLoading === "google" ? (
                <>
                  <span className="w-4 h-4 mr-2 border-2 border-foreground/30 border-t-foreground rounded-full animate-spin" />
