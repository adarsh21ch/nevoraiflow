// Shared Stripe utility — routes all api.stripe.com calls through the Lovable connector gateway.
// NEVER instantiate Stripe directly with Deno.env.get("STRIPE_SECRET_KEY") — those env vars
